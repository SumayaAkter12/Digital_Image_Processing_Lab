#3(c): Take a grayscale image of size 512x512, apply harmonic & geometric mean filter on the noisy image & compare their performance with PSNR
...
def compute_psnr(image1, image2):
    ...
    return round(psnr, 2)
#Loading the Image
character_image = cv2.imread('Characters_Test.tif', 0)
